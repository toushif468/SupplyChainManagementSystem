...
import { GetDashboardAnalyticsData } from '@services/fd-service/dashboard_service';
    ...
    <div className="business_analytics">
      <div style={{height: 'max-content'}}>
          ...
          <div className="ba-charts">
              ...
              <div className='pie-chart' style={{position: 'relative', padding: '0 20px 10px 20px', borderRadius: '10px', backgroundColor: '#223f3d', width: 'fit-content' }}>
                        <ReactApexChart options={topExpenseSectors.options} series={topExpenseSectors.series} type="pie" width={460} />
                    </div>

                    <div className='bar-chart' style={{ padding: '0 20px 20px', borderRadius: '10px', backgroundColor: '#223f3d', width: 'fit-content' }}>
                        <ReactApexChart options={topSellingProduct.options} series={topSellingProduct.series} type="bar" height={350} width={460} />
