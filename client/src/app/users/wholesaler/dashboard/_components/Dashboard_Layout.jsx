...
const DashboardLayout = ({ children }) => {
  ...
  const frmrTabClickAction = (e) => {
    ...
    if (e.target.innerHTML == "Stocked Products") {
                  ...
                  <div className='tab-wrapper'>
                    ...
                    <div className="w-layout-hflex frmr-tab-link-container">
                      <div className="frmr-tab-link-wrapper" >
                        <a className={end_pathname == "dashboard" ? "fpd-tab-link active" : "fpd-tab-link"} onClick={(e) => frmrTabClickAction(e)}>Stocked Products</a>
                      </div>
                      <div className="frmr-tab-link-wrapper">
